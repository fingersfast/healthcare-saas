  ...
  return (
    <section id="contact" className="bg-white py-16 md:py-24 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-24 -left-24 w-96 h-96 rounded-full bg-blue-50 blur-3xl opacity-70"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-gray-500 max-w-2xl mx-auto">
            Have questions about our platform? Contact us to learn more about
            how we can help your healthcare practice thrive.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          {/* Contact Information */}
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-8 md:p-12 text-white shadow-xl">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1">info@healthcarepro.com</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0">
